  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      <motion.p
        ...
        className="cursor-pointer w-full text-black hover:opacity-[0.9] dark:text-white"
      >
        {item}
      </motion.p>
      {active !== null && (
        ...
        >
          {active === item && (
            <div className="absolute top-[calc(100%_+_1.2rem)] transform -translate-x-1/2 pt-4">
              <motion.div
                transition={transition}
